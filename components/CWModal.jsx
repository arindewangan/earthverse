...
export default function CWModal({setIsOpen}) {
  ...
  return (
    <div>
      ...
      <div
        tabIndex={-1}
        aria-hidden="true"
        className="md:left-[25rem] md:top-[4rem] overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full justify-center items-center"
      >
